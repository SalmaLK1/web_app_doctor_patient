...
<body>
<div class="logo1">
    <a href="home.php" class="back-link"><i class="fas fa-home home-icon"></i> Revenir à l'accueil</a>
</div>
<div class="container">
            ...
            if(mysqli_num_rows($verify_query) != 0){
                ...
                if($file_error === 0){
                    ...
                    if(move_uploaded_file($file_tmp, $file_destination)){
                        ...
                        if ($role === "medecin") {
                            $speciality = $_POST['speciality'];
                            mysqli_query($con,"INSERT INTO users(Username,Email,Birthdate,Password,conf_password,ProfileImage,Speciality) VALUES('$username','$email','$birthdate','$password','$conf_password','$file_destination', '$speciality')") or die("Erreur survenue");
                        } else {
                            mysqli_query($con,"INSERT INTO users(Username,Email,Birthdate,Password,conf_password,ProfileImage) VALUES('$username','$email','$birthdate','$password','$conf_password','$file_destination')") or die("Erreur survenue");
                        }
